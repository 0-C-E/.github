= 0 C.E. --- Divine Statue #emph[(Special)] <0-ce--divine-statue-special>
...
#figure(
  align(center)[#table(
    ...
    table.hline(),                            [#strong[Type];],
    [Special (non-upgradable)],               [#strong[Slot];],
    [Divine Statue],                          [#strong[Max Level];],
    [1],                                      [#strong[Effects];],
    [Additional Favor production multiplier],
  )],
  kind: table,
)
