...
<96-cultural-events--city-progression>
...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [City Festival], [20], [Food + Gold], [12h],
    [Grand Games], [50], [Food + Wood + Gold], [24h],
    [Theatrical Performance], [30], [Wood + Gold], [16h],
    [Sacred Ceremony], [40], [Gold + Favor (any god)], [20h],
  )]
  , kind: table
  )
...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [Greece], [Olympic Games], [80], [Requires Stadium special
    building],
    [Sumer], [Ziggurat Dedication], [60], [Requires Ziggurat; celebrates
    completed building tier],
    [Egypt], [Sed Festival], [70], [Capital city only; Pharaoh\'s
    jubilee],
    [Rome], [Triumph], [65], [Requires military victory within last 7
    days],
    [Maya], [Blood Rite], [55], [Consumes population; generates Culture
