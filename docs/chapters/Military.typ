...
== 10. Military & Combat <10-military--combat>
...
=== 10.2 Unit Types <102-unit-types>

==== 10.2.1 Land Units (Barracks) <1021-land-units-barracks>
...
==== 10.2.4 Counter Rules (Hard vs Soft) <1024-counter-rules-hard-vs-soft>
...
==== 10.2.5 Land Unit Stat System <1025-land-unit-stat-system>
...
==== 10.2.6 Land Unit Recruitment Costs <1026-land-unit-recruitment-costs>
...
==== 10.2.7 Attack, Mixed, and Defense Specialization <1027-attack-mixed-and-defense-specialization>
...
=== 10.3 Army System <103-army-system>
...
=== 10.4 Formations <104-formations>
...
=== 10.5 Combat Resolution <105-combat-resolution>
...
==== 10.5.1 Attacker Morale (Progression Fairness) <1051-attacker-morale-progression-fairness>
...
=== 10.6 City Defense <106-city-defense>
...
=== 10.7 Loot & Capture <107-loot--capture>
...
=== 10.8 City Acquisition Systems (Conquest, Revolt, Rapid Siege) <108-city-acquisition-systems-conquest-revolt-rapid-siege>
...
==== 10.8.1 Shared Requirements <1081-shared-requirements>
...
==== 10.8.2 Conquest (Siege Worlds) <1082-conquest-siege-worlds>
#strong[Requires:]
...
==== 10.8.3 Revolt (Revolt Worlds) <1083-revolt-revolt-worlds>
#strong[Requires:]
...
==== 10.8.4 Rapid Siege (Game Night) <1084-rapid-siege-game-night>
...
==== 10.8.5 Key Notes and Exceptions <1085-key-notes-and-exceptions>
...
==== 10.8.6 Anti-Exploit Guardrails <1086-anti-exploit-guardrails>
