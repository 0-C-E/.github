...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [#strong[Full World];], [World Domination], [First alliance to
    control every city slot wins],
    [#strong[Campaign];], [Wonder Hold], [Construct the designated
    Wonder and hold for N days],
    [#strong[Skirmish];], [Score], [Highest Prestige at world end],
    [#strong[Game Night];], [Elimination or Score], [Last city standing,
    or highest score at time limit],
  )]
  , kind: table
  )

=== 14.2 Full World: World Domination
<142-full-world-world-domination>
...
=== 14.3 Campaign: Wonder Hold
<143-campaign-wonder-hold>
...
=== 14.5 Game Night: Elimination / Score
<145-game-night-elimination--score>
...
== 17. Prestige & Account Progression
<17-prestige--account-progression>
=== 17.1 Account-Level Persistence
<171-account-level-persistence>
...
=== 17.2 Prestige Sources
<172-prestige-sources>
#figure(
  align(center)[#table(
    columns: 2,
    align: (auto,auto,),
    ...
    table.hline(),
    [Wonder constructed], [+500],
    [Campaign victory], [+1,000],
    [Skirmish victory], [+300],
    [Military victories (cumulative)], [+25 each],
    [Cities founded (per world)], [+100 each],
    [Era advancements], [+200 each],
    [Trade milestones], [+50 each],
    [Diplomatic agreements], [+10 each],
    [Alliance founded], [+150],
  )]
  , kind: table
  )

=== 17.3 Prestige Rewards (Cosmetic Only)
<173-prestige-rewards-cosmetic-only>
