...
#figure(align(center)[#table(
  ...
  table.hline(),             [#strong[Era I: Foundation];],    [Basic agriculture,
  bronze tools,
  wooden structures],
  [Starting era],            [#strong[Era II: Classical];],    [Iron working, advanced
  military,
  philosophy],
  [500 RP + Era I complete], [#strong[Era III: Hellenistic];], [Engineering, siege
  craft, trade
  networks],
  [2,000 RP + Era II],       [#strong[Era IV: Imperial];],     [Advanced administration,
  elite units,
  Wonders],
  [5,000 RP + Era III],
)], kind: table)
...
#figure(align(center)[#table(
  ...
  Husbandry (+pop cap), Irrigation Techniques],              [#strong[Construction];],
  [Advanced Masonry (−10% build time), Arch
  & Vault (unlocks T3 buildings), Aqueduct],              [#strong[Military];],
  ...
  unit type at the Barracks or Siege Workshop],              [#strong[Commerce];],
  [Coinage (+gold/s), Long-Distance Trade
  (+route value), Maritime Routes],              [#strong[Espionage];],
  [Tradecraft (+1 spy slot), Deep Cover
  (+success rate), Cipher Systems],              [#strong[Divine];],
  [Sacred Rites (+Favor/s), Theogony (unlocks T2
  divine powers), Apotheosis (T3 unlock)],              [#strong[Naval];],
  [Trireme Design, Open-Ocean Navigation, Naval
  Tactics],              [#strong[Governance];],
