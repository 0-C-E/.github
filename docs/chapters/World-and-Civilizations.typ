...
#figure(
  align(center)[#table(
    ...
    [Deep Harbor], [1.0x], [-5%], [-10%], [+20%], [-5%], [0%],
    [Desert], [0.8x], [-20%], [+20%], [-25%], [+15%], [+10%],
    [Far Land (out of bounds)], [N/A], [0%], [0%], [0%], [0%], [0%],
    [Forest], [0.6x], [+30%], [-5%], [+10%], [-20%], [-15%],
    [Highlands], [0.7x], [-15%], [+20%], [-10%], [+20%], [-15%],
    [Hills], [0.5x], [-5%], [+25%], [+5%], [+5%], [-30%],
    [Mountains], [0.2x], [-20%], [+25%], [-20%], [+25%], [-10%],
    [Ocean], [1.0x (naval)], [0%], [0%], [+15%], [0%], [-15%],
    [Plains], [1.0x], [+5%], [-10%], [+25%], [-15%], [-5%],
    [Sacred Grove], [0.7x], [+10%], [-20%], [+5%], [-25%], [+30%],
    [Snowy Peaks], [0.3x], [-15%], [+5%], [-30%], [+35%], [+5%],
...
=== 4.6 Special Map Features
<46-special-map-features>
#figure(
  align(center)[#table(
    columns: 2,
    align: (auto, auto),
...
=== 5.2 Difficulty & Archetype Overview
<52-difficulty--archetype-overview>
#figure(
  align(center)[#table(
    columns: 4,
...
=== 5.5 Egypt --- The Eternal Kingdom
<55-egypt--the-eternal-kingdom>
...
=== 5.6 Rome --- The Eternal Administration
...
=== 5.8 Civilization Data Schema
<58-civilization-data-schema>
...
=== 5.9 Future Civilization Candidates (Post-MVP)
<59-future-civilization-candidates-post-mvp>
