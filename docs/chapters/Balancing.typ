...
=== 23.2 Anti-Snowball Mechanisms
<232-anti-snowball-mechanisms>
#figure(
  align(center)[#table(
    columns: 2,
    align: (auto,auto,),
    ...
    table.hline(),
    [#strong[Grievance Bonus];], [Player who loses a city to capture
    receives a temporary +20% production boost],
    [#strong[Multi-City Tax];], [Exponential city maintenance costs
    punish over-extension],
    [#strong[Trade Dependency];], [Gold-vein scarcity means dominant
    players need trade to sustain military upkeep],
    [#strong[Wonder Magnet];], [Holding a Wonder makes you every
    player\'s primary target],
    [#strong[Domination Pressure];], [As an alliance approaches full map
...
=== 23.3 Balance Levers (Per World)
<233-balance-levers-per-world>
