...
== 16. Social Systems
<16-social-systems>
=== 16.1 Messaging & Forums
<161-messaging--forums>
...
#figure(
  align(center)[#table(
    ...
    table.hline(),
    [Direct Message], [Player ↔ Player], [Persists for world lifetime],
    [Alliance Forum], [Alliance members], [Persists; threaded],
    [Alliance Chat], [Alliance members], [Session-persistent],
    [Diplomatic Channel], [Two players/alliances], [Persists; formal
    tone],
    [World Announcement], [All players], [Public; throttled],
    [Combat Report], [Battle participants], [Auto-generated; narrative],
    [Event Feed], [Individual player], [Personal notification stream],
  )]
  , kind: table
  )
...
=== 16.3 Player Reputation
<163-player-reputation>
